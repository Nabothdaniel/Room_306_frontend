...
const EscortDetailsSecFive = () => {
  return (
    <div className="rounded-xl lg:px-16 px-8 pb-10 bg-[#1E1E1E] ">
      <div className="pt-16">
        <h2 className="text-2xl font-semibold text-white">Verification</h2>

        <div className="text-white pt-8">
          <h3 className="text-lg pb-4 lg:max-w-[900px]">
          ...
          <ol className=" list-decimal pl-8 text-white">
          ...
          <h2 className="text-lg pb-4 pt-5">
