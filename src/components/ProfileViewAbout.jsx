    ...
    <div className="pt-10 text-[#DADADA]">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 text-[15px] pt-3 gap-y-6 md:gap-y-8">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="font-semibold">Jabi</p>
        </div>
        <div className="flex flex-col justify-center">
